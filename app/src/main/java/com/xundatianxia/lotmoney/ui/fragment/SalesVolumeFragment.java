...
public class SalesVolumeFragment extends BaseFragment {
    ...
    public static SalesVolumeFragment newInstance(ArrayList<HomeListBean> listBeans) {
        Bundle args = new Bundle();
        SalesVolumeFragment fragment = new SalesVolumeFragment();
        args.putParcelableArrayList("SalesV", listBeans);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            homeListBeans = getArguments().getParcelableArrayList("SalesV");
        }
    }
